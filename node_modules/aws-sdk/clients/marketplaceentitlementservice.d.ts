...
declare class MarketplaceEntitlementService extends Service {
   ...
   */
  constructor(
    options?: MarketplaceEntitlementService.Types.ClientConfiguration
  );
   ...
   */
  getEntitlements(
    params: MarketplaceEntitlementService.Types.GetEntitlementsRequest,
    callback?: (
      err: AWSError,
      data: MarketplaceEntitlementService.Types.GetEntitlementsResult
    ) => void
  ): Request<
    MarketplaceEntitlementService.Types.GetEntitlementsResult,
    AWSError
  >;
  /**
   * GetEntitlements retrieves entitlement values for a given product. The results can be filtered based on customer identifier or product dimensions.
