...
declare class CUR extends Service {
  ...
  deleteReportDefinition(
    params: CUR.Types.DeleteReportDefinitionRequest,
    callback?: (
      err: AWSError,
      data: CUR.Types.DeleteReportDefinitionResponse
    ) => void
  ): Request<CUR.Types.DeleteReportDefinitionResponse, AWSError>;
  /**
   * Deletes the specified report.
   */
  deleteReportDefinition(
  ...
  describeReportDefinitions(
    params: CUR.Types.DescribeReportDefinitionsRequest,
    callback?: (
      err: AWSError,
      data: CUR.Types.DescribeReportDefinitionsResponse
    ) => void
  ): Request<CUR.Types.DescribeReportDefinitionsResponse, AWSError>;
  /**
   * Lists the AWS Cost and Usage reports available to this account.
   */
  describeReportDefinitions(
  ...
  modifyReportDefinition(
    params: CUR.Types.ModifyReportDefinitionRequest,
    callback?: (
      err: AWSError,
      data: CUR.Types.ModifyReportDefinitionResponse
    ) => void
  ): Request<CUR.Types.ModifyReportDefinitionResponse, AWSError>;
  /**
   * Allows you to programatically update your report preferences.
   */
  modifyReportDefinition(
   ...
   */
  putReportDefinition(
    params: CUR.Types.PutReportDefinitionRequest,
    callback?: (
      err: AWSError,
      data: CUR.Types.PutReportDefinitionResponse
    ) => void
  ): Request<CUR.Types.PutReportDefinitionResponse, AWSError>;
  /**
   * Creates a new report using the description that you provide.
   */
  putReportDefinition(
