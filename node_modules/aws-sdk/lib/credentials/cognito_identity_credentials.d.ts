...
export class CognitoIdentityCredentials extends Credentials {
   ...
   */
  constructor(
    options: CognitoIdentityCredentials.CognitoIdentityOptions,
    clientConfig?: ConfigurationOptions
  );
  /**
   ...
   */
  data:
    | CognitoIdentity.Types.GetCredentialsForIdentityResponse
    | STS.Types.AssumeRoleWithWebIdentityResponse;
  /**
   ...
   */
  params:
    | CognitoIdentity.Types.GetIdInput
    | CognitoIdentity.Types.GetOpenIdTokenInput
    | STS.Types.AssumeRoleWithWebIdentityRequest;
}

// Needed to expose interfaces on the class
declare namespace CognitoIdentityCredentials {
  export type CognitoIdentityCredentialsInputs =
  ...
  export type CognitoIdentityOptions = CognitoIdentityCredentialsInputs & {
    LoginId?: string;
  };
