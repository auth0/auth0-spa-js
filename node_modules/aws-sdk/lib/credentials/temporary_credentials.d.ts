...
export class TemporaryCredentials extends Credentials {
   ...
   */
  constructor(
    options: TemporaryCredentials.TemporaryCredentialsOptions,
...
declare namespace TemporaryCredentials {
  export type TemporaryCredentialsOptions =
    | STS.Types.AssumeRoleRequest
    | STS.Types.GetSessionTokenRequest;
}
