...
AWS.Service = inherit({
  ...
  initialize: function initialize(config) {
    ...
    if (
      (this.config.clientSideMonitoring || AWS.Service._clientSideMonitoring) &&
      this.publisher
    ) {
  ...
  apiCallEvent: function apiCallEvent(request) {
    ...
    var monitoringEvent = {
      ...
      Version: 1,
      Service:
        request.service.api.serviceId || request.service.api.endpointPrefix,
  ...
  isClockSkewed: function isClockSkewed(newServerTime) {
    if (newServerTime) {
      return (
        Math.abs(this.getSkewCorrectedDate().getTime() - newServerTime) >= 30000
      );
    }
  },
