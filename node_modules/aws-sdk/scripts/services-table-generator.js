...
fs_1.writeFileSync(
  path_1.resolve(__dirname, '..', 'SERVICES.md'),
  Object.keys(clients).reduce(function(serviceTable, clientId) {
    var cid = clientId.toLowerCase();
    return (
      serviceTable +
      Object.keys(api_loader.services[cid])
        .reverse()
