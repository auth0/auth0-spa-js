...
AddChangeCli.prototype = {
  ...
  promptType: function promptType() {
    ...
    return this.retrieveInputAsync().then(this.processType.bind(this));
  },
  ...
  promptCategory: function promptCategory() {
    ...
    this.print(
      'category: ' + (existingCategory ? '(' + existingCategory + ') ' : '')
    );
    return this.retrieveInputAsync().then(this.processCategory.bind(this));
  },
  ...
  promptDescription: function promptDescription() {
    ...
    return this.retrieveInputAsync().then(this.processDescription.bind(this));
  },
