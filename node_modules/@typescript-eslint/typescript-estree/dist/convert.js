  ...
  convertNode(node, parent) {
    switch (node.kind) {
      ...
      case SyntaxKind.MethodDeclaration: {
        ...
        if (
          result.key.type === ts_estree_1.AST_NODE_TYPES.Identifier &&
          node.questionToken
        ) {
      ...
      case SyntaxKind.Constructor: {
        ...
        const constructorToken =
          (lastModifier &&
            node_utils_1.findNextToken(lastModifier, node, this.ast)) ||
          node.getFirstToken();
      ...
      case SyntaxKind.Parameter: {
        ...
        if (node.modifiers) {
          return this.createNode(node, {
            ...
            accessibility:
              node_utils_1.getTSNodeAccessibility(node) || undefined,
            readonly:
              node_utils_1.hasModifier(SyntaxKind.ReadonlyKeyword, node) ||
              undefined,
            static:
      ...
      case SyntaxKind.MappedType: {
        ...
        if (node.readonlyToken) {
          if (node.readonlyToken.kind === SyntaxKind.ReadonlyKeyword) {
            ...
            result.readonly = node_utils_1.getTextForTokenKind(
        ...
        if (node.questionToken) {
          if (node.questionToken.kind === SyntaxKind.QuestionToken) {
            ...
            result.optional = node_utils_1.getTextForTokenKind(
