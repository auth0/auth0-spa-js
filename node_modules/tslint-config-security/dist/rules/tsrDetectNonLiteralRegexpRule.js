...
var Rule = (function (_super) {
    ...
    Rule.metadata = {
        ...
        descriptionDetails: Lint.Utils.dedent(templateObject_1 || (templateObject_1 = tslib_1.__makeTemplateObject(["Any usage of new RegExp()\n            with non-literal argument will trigger a warning.\n            See https://github.com/webschik/tslint-config-security#tsr-detect-non-literal-regexp"], ["Any usage of new RegExp()\n            with non-literal argument will trigger a warning.\n            See https://github.com/webschik/tslint-config-security#tsr-detect-non-literal-regexp"]))),
        optionsDescription: '',
        options: null,
        type: 'functionality',
